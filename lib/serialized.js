...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = abro_grop.decodeJid(abro_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let abro_bot = {
      ...group_sss,
    };
    abro_bot.chat = abro_bot.jid = abro_bot.from = group_sss.id;
    abro_bot.user = abro_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    abro_bot.name = await abro_grop.getName(abro_bot.user);
    abro_bot.userNum = abro_bot.senderNum = abro_bot.user.split("@")[0];
    abro_bot.time = getTime("h:mm:ss a");
    abro_bot.date = getTime("dddd, MMMM Do YYYY");
    abro_bot.action = abro_bot.status = group_sss.action;
    abro_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
      ...
      .includes(abro_bot.user);
    abro_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(abro_bot.user);
    abro_bot.fromMe = abro_bot.isAstro
      ? true
      : areJidsSameUser(abro_bot.user, _0x33935f);
    if (abro_bot.action === "remove" && abro_bot.fromMe) {
      return;
    }
    abro_bot.abroBot = [...Astro]
    ...
    ].includes(abro_bot.chat);
    abro_bot.isGroup = abro_bot.chat.endsWith("@g.us");
    if (abro_bot.isGroup) {
      abro_bot.metadata = await abro_grop.groupMetadata(abro_bot.chat);
      gcs[abro_bot.chat] = abro_bot.metadata;
      abro_bot.admins = abro_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      abro_bot.isAdmin = !!abro_bot.admins.find(
        (_0x859f83) => _0x859f83.id === abro_bot.user
      );
      abro_bot.isBotAdmin = !!abro_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    abro_bot.kick = abro_bot.remove = (_0x48f5af = abro_bot.user) =>
      abro_grop.groupParticipantsUpdate(abro_bot.chat, [_0x48f5af], "remove");
    abro_bot.add = (_0x422af3 = abro_bot.user) =>
      abro_grop.groupParticipantsUpdate(abro_bot.chat, [_0x422af3], "add");
    abro_bot.promote = (_0x3d0644 = abro_bot.user) =>
      abro_grop.groupParticipantsUpdate(abro_bot.chat, [_0x3d0644], "promote");
    abro_bot.demote = (_0x37d435 = abro_bot.user) =>
      abro_grop.groupParticipantsUpdate(abro_bot.chat, [_0x37d435], "demote");
    abro_bot.getpp = async (_0x577c8f = abro_bot.user) => {
      try {
        return await abro_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    abro_bot.sendMessage = async (
      _0x5a0f4b = abro_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await abro_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    abro_bot.sendUi = async (
      _0x107cb3 = abro_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
    ...
    abro_bot.error = async (
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        abro_bot.chat !== abro_bot.botNumber
      ) {
        await abro_grop.sendMessage(abro_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await abro_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [abro_bot.user],
          },
          {
    ...
    abro_bot.send = async (
      ...
      _0xb61629 = "abro",
      _0x919f26 = "",
      _0x3ccfb1 = abro_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : abro_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await abro_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await abro_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await abro_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await abro_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    abro_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = abro_bot.jid
    ) => {
      return await abro_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    abro_bot.checkBot = (_0x31c33b = abro_bot.sender) =>
      [...Astro, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    abro_bot.botNumber = _0x33935f;
    abro_bot.bot = _0x56741f ? abro_grop : {};
    if (global.AstroOfficial && global.AstroOfficial === "yes") {
      return abro_bot;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("abroMD");
  ...
  _0x2d6cd0.getpp = async (_0x267509 = _0x2d6cd0.sender) => {
    try {
      ...
      return "https://imgur.com/sm0w91L.jpeg";
    }
  };
